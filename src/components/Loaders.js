...
function freelancerLoader() {
  return (
    ['i1', 'i2', 'i3', 'i4'].map((item) => (
      <div key={item} className="border ml-1 col-auto rounded shadow-lg w-1/4 px-4 mb-6 flex flex-col items-center justify-center mobileWidth mobilePadding mx-auto">
        <div className="animate-pulse flex w-full flex-col  space-x-4">
